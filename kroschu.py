...
if st.session_state.current_page == "Dashboard":
    ...
    st.image("predictions.png" if Path("predictions.png").exists() else "https://via.placeholder.com/800x400", use_container_width=True)
    st.image("metriques.png" if Path("metriques.png").exists() else "https://via.placeholder.com/800x400", use_container_width=True)
